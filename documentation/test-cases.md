...
| ID | Test Case | Preconditions | Steps | Expected Result | Priority | Status |
|----|-----------|--------------|-------|-----------------|----------|--------|
| TC-25 | Mobile layout (375px) | N/A | 1. Open application at 375x667 viewport | No horizontal scrollbar. Content readable. Create button accessible. Header elements do not overlap. | P2 | ❌ [BUG-008](bug-report/BUG-008-mobile-header-overlap.md) |
| TC-26 | Mobile dialog fits viewport | 375px viewport, dialog open | 1. Open any dialog on mobile | Dialog fully visible. Textarea usable. Buttons tappable. No overflow. | P2 | ✅ |
